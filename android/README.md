...
```gradle
dependencies {
    implementation 'com.github.apiverve:guidgenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.guidgenerator.GUIDGeneratorAPIClient;
import com.apiverve.guidgenerator.APIResponse;
import com.apiverve.guidgenerator.APIException;

// Initialize the client
GUIDGeneratorAPIClient client = new GUIDGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/guidgenerator](https://docs.apiverve.com/ref/guidgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/guidgenerator](https://docs.apiverve.com/ref/guidgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/guidgenerator-api/issues)
