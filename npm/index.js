...
class guidgeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/guidgenerator');
        }
        ...
        this.validationRules = {"count":{"type":"integer","required":false,"min":1,"max":100,"default":1},"format":{"type":"string","required":false,"default":"default"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/guidgenerator`);
        }
    }
...
module.exports = guidgeneratorWrapper;
