/*
 * GUID Generator API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the GUID Generator API.
 * API Documentation: https://docs.apiverve.com/ref/guidgenerator
 */
...
{
    class GUIDGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/guidgenerator";

        /// <summary>
        /// Make a GET request to the GUID Generator API
        /// </summary>
        static async Task<JsonDocument> CallGUIDGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;count&quot;] &#x3D; &quot;3&quot;, [&quot;format&quot;] &#x3D; &quot;uppercase&quot; };
        ...
        {
            Console.WriteLine("📤 Calling GUID Generator API...\n");

            var result = await CallGUIDGeneratorAPI();
