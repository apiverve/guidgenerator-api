// Package guidgenerator provides a Go client for the GUID Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/guidgenerator?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/guidgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the GUID Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new GUID Generator API client.
...
// Execute makes a request to the GUID Generator API with typed parameters.
//
...
//   - count: integer - Number of GUIDs to generate [min: 1, max: 100]
