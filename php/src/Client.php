...
namespace APIVerve\Guidgenerator;
...
/**
 * Client for the GUID Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/guidgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/guidgenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\GuidgeneratorClient] {$message}\n";
        }
    }
}
